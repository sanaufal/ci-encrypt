    ...
    <div class="header-container">
        <div class="header-left">
            <div class="navigation-toggler">
                <a href="javascript:void();" data-action="navigation-toggler">
            ...
            <div class="header-logo">
                <a href="<?php echo base_url(); ?>">
                    <img class="logo" src="<?php echo base_url(); ?>assets/media/dmtekno-logo-text.png" alt="logo" title="Logo" height="40" logo-white="on">
                </a>
            </div>
        </div>
        ...
        <div class="header-body">
            <div class="header-body-left">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown d-none d-md-block">
                        <a href="javascript:void();" class="nav-link" title="Apps" data-toggle="dropdown">Apps</a>
                    ...
                    <li class="nav-item dropdown d-none d-md-block">
                        <a href="javascript:void();" class="nav-link" title="Actions" data-toggle="dropdown">Create</a>
                        <div class="dropdown-menu">
                            <a href="javascript:void();" class="dropdown-item">Add Products</a>
                            <a href="javascript:void();" class="dropdown-item">Add Category</a>
                            <a href="javascript:void();" class="dropdown-item">Add Report</a>
                            <div class="dropdown-divider"></div>
                            <a href="javascript:void();" class="dropdown-item">Reports</a>
                            <a href="javascript:void();" class="dropdown-item">Customers</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="header-body-right">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="javascript:void();" class="nav-link mobile-header-search-btn" title="Search">
                            <i data-feather="search"></i>
                        </a>
                    </li>

                    <li class="nav-item dropdown d-none d-md-block">
                        <a href="javascript:void();" class="nav-link" title="Fullscreen" data-toggle="fullscreen">
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void();" class="nav-link nav-link-notify" title="Chats" data-sidebar-target="#chat-list">
                            <i data-feather="message-circle"></i>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a href="javascript:void();" class="nav-link nav-link-notify" title="Notifications" data-toggle="dropdown">
                            ...
                            <div class="dropdown-scroll">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="px-4 py-3 list-group-item">
                                        <a href="javascript:void();" class="d-flex align-items-center hide-show-toggler">
                            ...
                            <div class="px-4 py-3 text-right border-top">
                                <ul class="list-inline small">
                                    <li class="list-inline-item mb-0">
                                        <a href="javascript:void();">Mark All Read</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a href="javascript:void();" title="Cart" class="nav-link" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            ...
                            <div class="dropdown-scroll">
                                <div class="list-group list-group-flush">
                                    <a href="javascript:void();" class="px-4 py-3 list-group-item d-flex">
                                        <div class="flex-shrink-0">
                                            <figure class="avatar mr-3">
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void();" class="nav-link" title="Settings" data-sidebar-target="#settings">
                            <i data-feather="settings"></i>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a href="javascript:void();" class="nav-link dropdown-toggle" title="User menu" data-toggle="dropdown">
                            <figure class="avatar avatar-sm">
                                <img src="<?php echo base_url(); ?>assets/media/image/user/man_avatar3.jpg" class="rounded-circle" alt="avatar">
                            </figure>
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="text-center py-4">
                                ...
                                <a href="<?php echo base_url('settings/profile'); ?>" class="btn btn-outline-light btn-rounded">Manage Your Account</a>
                            </div>
                            <div class="list-group">
                                <a href="<?php echo base_url(); ?>" class="list-group-item">View Profile</a>
                                <a href="<?php echo base_url('login/logout'); ?>" class="list-group-item text-danger">Sign Out!</a>
                            </div>
                            <div class="p-4">
                                <div class="mb-4">
