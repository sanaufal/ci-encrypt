<div class="page-header d-md-flex justify-content-between">
    ...
    <div class="mt-3 mt-md-0">
        ...
        <a href="index.html#" class="btn btn-primary ml-0 ml-md-2 mt-2 mt-md-0 dropdown-toggle" data-toggle="dropdown">Actions</a>
        <div class="dropdown-menu dropdown-menu-right">
            <a href="index.html#" class="dropdown-item">Download</a>
            <a href="index.html#" class="dropdown-item">Print</a>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="index.html#" class="btn btn-floating">
                            <i class="ti-reload"></i>
                        </a>
                        <div class="dropdown">
                            <a href="index.html#" data-toggle="dropdown" class="btn btn-floating" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-0"><a href="index.html#" class="link-1">See comments</a> and respond to customers' comments.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-0"><a class="link-1" href="index.html#">See visits</a> that had a higher than expected
                            bounce rate.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-0"><a class="link-1" href="index.html#">See referring</a> domains that sent most visits
                            last month.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-0"><a class="link-1" href="index.html#">See clients</a> that accepted your invitation to
                            connect.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="index.html#" class="btn btn-floating" data-toggle="dropdown">
                            <i class="ti-more-alt"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="index.html#">Action</a>
                ...
                <div class="mt-3">
                    <a href="index.html#" class="btn btn-info">Report Detail</a>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <a href="index.html#" class="btn btn-warning">Statistics Detail</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="index.html#" class="link-1">View All</a>
                </div>
                <div class="card-scroll" style="height: 430px">
                    <ul class="list-group list-group-flush">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="ml-auto">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="index.html#" class="dropdown-item">View</a>
                                                <a href="index.html#" class="dropdown-item">Send Message</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li class="list-group-item d-flex px-0 py-4">
                            <a href="index.html#" class="flex-shrink-0">
                                <figure class="avatar mr-3">
                                    <img src="<?php echo base_url(); ?>assets/media/image/user/man_avatar3.jpg" class="rounded-circle" alt="image">
                                </figure>
                            </a>
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <p>This chart shows total sales. You can use the button below for details of this
                        month's sales.</p>
                    <div class="mt-4">
                        <a href="index.html#" class="btn btn-primary">View Detail</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table id="recent-orders" class="table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product1.png" class="rounded mr-3" alt="Vase">
                                <span>Vase</span>
                            </a>
                        </td>
                        ...
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="index.html#" class="dropdown-item">View Detail</a>
                                    <a href="index.html#" class="dropdown-item">Send</a>
                                    <a href="index.html#" class="dropdown-item">Edit</a>
                                    <a href="index.html#" class="dropdown-item text-danger">Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product2.png" class="rounded mr-3" alt="Glasses">
                                <span>Glasses</span>
                            </a>
                        </td>
                        <td>Holmes Hines</td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product3.png" class="rounded mr-3" alt="Plate">
                                <span>Plate</span>
                            </a>
                        </td>
                        <td>Serena Glover</td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product4.png" class="rounded mr-3" alt="Pen">
                                <span>Pen</span>
                            </a>
                        </td>
                        <td>Dianne Prince</td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product5.png" class="rounded mr-3" alt="Armchair">
                                <span>Armchair</span>
                            </a>
                        </td>
                        <td>Morgan Pitts</td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product6.png" class="rounded mr-3" alt="Flowerpot">
                                <span>Flowerpot</span>
                            </a>
                        </td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product7.png" class="rounded mr-3" alt="Wall Clock">
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product8.png" class="rounded mr-3" alt="Desk">
                                <span>Desk</span>
                            </a>
                        </td>
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product9.png" class="rounded mr-3" alt="Night Light">
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="<?php echo base_url(); ?>assets/media/image/products/product10.png" class="rounded mr-3" alt="Shoe">
                                <span>Shoe</span>
                            </a>
                        </td>
                        <td>Cole Holcomb</td>
